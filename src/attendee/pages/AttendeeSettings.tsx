        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
          ...
          <section>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <p style={{ color: 'var(--org-text-primary)', fontWeight: 600, fontSize: '1.2rem' }}>{user?.user_metadata?.full_name || 'Student'}</p>
              <p style={{ color: 'var(--org-text-secondary)', fontSize: '0.95rem' }}>{user?.email}</p>
              <div style={{ marginTop: '0.5rem' }}>
                <span className="org-badge org-badge--success">Active as Student</span>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p style={{ color: 'var(--org-text-secondary)', fontSize: '0.95rem', lineHeight: 1.6, marginBottom: '1.5rem', maxWidth: '600px' }}>
              You are currently using the FestForge Student Portal. If you are part of a college fest organizing committee, you can switch to the Organizer Portal to manage your events.
            </p>
            ...
            <button
              ...
              style={{ width: 'auto' }}
            >
              {isSwitching ? 'Switching Role...' : 'Switch to Organizer Portal'}
            </button>
          </section>
        </div>
      </motion.div>
