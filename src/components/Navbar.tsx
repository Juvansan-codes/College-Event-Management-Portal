  ...
  return (
    <nav className="sticky top-0 z-50 bg-white border-b border-[#e7e7e7] flex items-center justify-between px-10 h-[60px]">
      ...
      <div className="flex items-center gap-2.5">
        <Link
          to="/signin"
          className="px-[18px] py-[7px] rounded-lg border border-[#d0d0d0] bg-transparent text-[0.85rem] font-semibold text-[#111] cursor-pointer hover:bg-[#f5f5f5] hover:border-[#aaa] transition-all duration-200"
        >
          Sign in
        </Link>
        <Link
          to="/signup"
          className="px-[18px] py-[7px] rounded-lg border-none bg-[#111] text-white text-[0.85rem] font-semibold cursor-pointer hover:bg-[#333] hover:-translate-y-px transition-all duration-200"
        >
          Register
        </Link>
      </div>
